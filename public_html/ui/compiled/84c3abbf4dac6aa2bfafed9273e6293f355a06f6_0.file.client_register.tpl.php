<?php
/* Smarty version 3.1.39, created on 2022-06-13 23:05:27
  from '/home/fatura.suainformatica.com.br/public_html/ui/theme/ibilling/client_register.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_62a7faf7ed7ae6_03314964',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '84c3abbf4dac6aa2bfafed9273e6293f355a06f6' => 
    array (
      0 => '/home/fatura.suainformatica.com.br/public_html/ui/theme/ibilling/client_register.tpl',
      1 => 1655175926,
      2 => 'file',
    ),
  ),
...
function content_62a7faf7ed7ae6_03314964 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en" class="coming-soon">
<head>
    <meta charset="utf-8">
    <title>Cadastro - <?php echo $_smarty_tpl->tpl_vars['_title']->value;?>
</title>
...
client/register_post/" id="iform">
                <div class="panel panel-default alt md-card">
                    <div class="panel-heading"><Center><h2>Formulário de Cadastro</h2></Center></div>
                    <div class="panel-body">
                        <form action="" class="">
                            <div class="form-group">
                                <label for="fullname" class="control-label">Nome Completo</label>
                                <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Ex: Carlos da Silva">
                            </div>

                             <div class="form-group">
                                <label for="company" class="control-label">Empresa</label>
                                <input type="text" class="form-control" id="company" name="company" placeholder="Ex: Ponto Com Informática">
                            </div>

                             <div class="form-group">
                                <label for="phone" class="control-label">Contato - Whatsapp</label>
                                <input type="text" class="form-control" id="phone" name="phone" placeholder="Ex: (67) 99999-9999)">
                            </div>

                            
                             <div class="form-group">
                                <label for="address" class="control-label">Endereço</label>
                                <input type="text" class="form-control" id="address" name="address" placeholder="Ex: Rua Brasil, Numero: 90, Bairro Centro">
                            </div>

                            <div class="form-group">
                                <label for="email" class="control-label">Email</label>
                                <input type="text" class="form-control" id="email" name="email" placeholder="Ex: seuemail@gmail.com">
                            </div>
                            <div class="form-group">
                                <label for="password" class="control-label">Crie uma Senha</label>
                                <input type="password" class="form-control" id="password" name="password" placeholder="******">
                            </div>
                            <div class="form-group">
                                <label for="password2" class="control-label">Confirme a Senha</label>
...
"></div>
                    ...
                    <div class="panel-footer">
                        <div class="clearfix">
                            <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
client/login/" class="pull-left mt-xs">Já é registrado? Logar</a>
                            <button type="submit" id="btn_form_action" class="btn btn-primary pull-right">Cadastrar</button>
                        </div>
                    </div>
                </div>
            </form>
