    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            ...
            <div class="text-center">
                <a href="{$_url}client/register/" class="mb20"><i class="ion-social-facebook"></i>Cadastre-se!</a> |
                <a href="{$_url}client/forgot_pw/" class="mb20"><i class="ion-social-twitter"></i>Esqueceu a senha ?</a>
            </div>
        </div>
    </div>
</div>
